...
const MenuComandas = () => {
    ...
    const enviarListaProductos = async (detallePedido, idp) => {
        try {
            ...
            const response = await fetch('https://projectdjangobakfebrero-production.up.railway.app/producto/procesar_productos/', {
                method: 'POST',
                body: formData,
            });
    ...
    const obtenerPedidos = async () => {
        try {
            const response = await fetch('https://projectdjangobakfebrero-production.up.railway.app/Mesero/pedidos/');
