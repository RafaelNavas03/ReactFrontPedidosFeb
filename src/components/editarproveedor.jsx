...
const EditarProveedor = ({ initialValues, onFinish, onCancel }) => {
    ...
    const handleUpdateProveedor = async (values) => {
        try {
            ...
            const response = await axios.post(`https://projectdjangobakfebrero-production.up.railway.app/Proveedores/editar_proveedor/${initialValues.id_proveedor}/`, formData, {
                headers: {
